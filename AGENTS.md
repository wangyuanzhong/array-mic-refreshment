...
**每次 push 后监控 GitHub Actions 直至全绿（自动 rule）** 见 [`.cursor/rules/post-push-ci-green.mdc`](.cursor/rules/post-push-ci-green.mdc)；细节与排错见 [`skills/github-actions-ci/SKILL.md`](skills/github-actions-ci/SKILL.md)。
