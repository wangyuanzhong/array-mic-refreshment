# 上游 Skill / System Prompt（原文副本）

本目录存放 **第三方仓库的原文**（或从其源码提取的 prompt），本应用 **不自行编写** Specialist 正文。
...
| `danielrosehill/text-transform/to-do-list.md` | …/by-use-case/to-do-list.md |
| `florianbruniaux/voice-refine.SKILL.md` | https://github.com/FlorianBruniaux/claude-code-ultimate-guide/blob/main/examples/skills/voice-refine/SKILL.md |
| `majiayu000/dictation-githubnext-gh-aw-2.SKILL.md` | https://github.com/majiayu000/claude-skill-registry/blob/main/skills/other/dictation-githubnext-gh-aw-2/SKILL.md |
| `shanttoosh/voice-controlled-ai-agent.intent-classification.md` | 提取自 https://github.com/shanttoosh/voice-controlled-ai-agent/blob/main/agent/intent.py |

许可：使用前请阅读各上游仓库 LICENSE。
