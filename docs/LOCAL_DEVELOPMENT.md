...
# 6b) 路线 B Phase 2 + 功能预设自动化（Windows；Web Bridge，不含 §10.2 麦克风手测）
...
| PTT 含字母/数字键后前台误输入或流程错乱 | 主键未吞掉、OS 仍认为键按下 | **V0.5.7+** `PttChordKeySuppressor`（**V0.5.8+** 仅按住 PTT 时装钩子） |
| 按 PTT 无 HUD / 瞬间结束；设置输入卡 | V0.5.7 空闲时全局钩子吞键 | **V0.5.8+** 钩子仅 PTT 激活期安装 |
